...
function Header() {
    ...
    return (
        <div className='flex justify-between gap-3 md:gap-2 items-center p-6 '>
            ...
            <button className='bg-black text-white p-3 px-6 rounded-full text-[25px] hidden md:block' onClick={() => router.push('/')}>
                Home
            </button>
            <button className='font-semibold p-3 px-6 rounded-full text-[25px]'
